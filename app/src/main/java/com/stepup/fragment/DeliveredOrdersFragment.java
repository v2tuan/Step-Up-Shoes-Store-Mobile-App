...
import com.stepup.databinding.FragmentDeliveredOrdersBinding;
...
public class DeliveredOrdersFragment extends Fragment {
    ...
    FragmentDeliveredOrdersBinding binding;
    ...
    private void getOrder(){
        ...
        callOrderByStatus = apiService.getOrdersByStatus(OrderShippingStatus.DELIVERED.toString());
