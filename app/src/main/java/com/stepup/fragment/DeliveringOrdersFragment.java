...
import com.stepup.databinding.FragmentDeliveringOrdersBinding;
...
public class DeliveringOrdersFragment extends Fragment {
    ...
    FragmentDeliveringOrdersBinding binding;
    Call<ResponseObject> callOrderByStatus;
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        binding = FragmentDeliveringOrdersBinding.inflate(inflater, container, false);
        getOrder();
    ...
    private void getOrder(){
        ...
        callOrderByStatus = apiService.getOrdersByStatus(OrderShippingStatus.DELIVERING.toString());
